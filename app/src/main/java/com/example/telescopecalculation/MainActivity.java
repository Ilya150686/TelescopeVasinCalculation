package com.example.telescopecalculation;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView creditTermOut = findViewById(R.id.creditTermOut);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView monthlyPaymentsOut = findViewById(R.id.monthlyPaymentsOut);

        StringBuilder monthlyPaymentsOutText = new StringBuilder();
        int monthCounter = 0;

        monthlyPaymentsOutText.append("Первоначальный бюджет: ").append(account).append('\n');
        monthlyPaymentsOutText.append("Стипендия: ");
        ...
        creditTermOut.setText("Возможность купить телескоп появится через " + monthCounter + " месяцев");
